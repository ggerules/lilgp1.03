...
kobjects = main.o gp.o eval.o tree.o change.o crossovr.o reproduc.o \
	mutate.o collapse.o uniform_mutate.o select.o tournmnt.o bstworst.o \
	fitness.o exch.o populate.o ephem.o ckpoint.o event.o pretty.o individ.o \
	genspace.o params.o random.o memory.o output.o cgp_czj.o cgp2_czj.o 

kheaders = event.h defines.h types.h protos.h protoapp.h cgp_czj.h cgp2_czj.h 
