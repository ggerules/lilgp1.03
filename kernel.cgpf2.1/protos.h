...
/***** czj:
    6/18/96
    added support for collapse and uniform_mutate operators
******/

/*** collapse.c ***/

int operator_collapse_init ( char *options, breedphase *bp );
void operator_collapse_free ( void * );
void operator_collapse_start ( population *oldpop, void *data );
void operator_collapse_end ( void *data );
void operator_collapse ( population *oldpop, population *newpop, void *data );
