...
/***************** czj: 
  ...
  one more member added to count exp[ressiveness
...
typedef struct
{
     int s;                  /* how big the child tree was, saved number for the skip node. used in chpoint.c */
     function *f;
     ephem_const *d;
     double wheelExt_czj;    /* wheel entry for crossover on extetrnal nodes */
     double wheelInt_czj;                         /* same for internal nodes */
     int expressed_czj;                        /* counter for expressiveness */
