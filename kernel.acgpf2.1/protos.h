...
population *regrow_population_czj ( population *pop, breedphase * );
...
void get_memory_stats ( long *total, long *free, long *max,
                       long *mallocc, long *reallocc, long *freec );
...
void generate_random_full_tree ( int space, int depth, int tr, function_set * );
void generate_random_grow_tree ( int space, int depth, int tr, function_set * );
...
lnode *get_subtree (int tr, lnode *, int );
lnode *get_subtree_recurse (int tr, lnode **, int * );

lnode *get_subtree_internal (int tr, lnode *, int );
lnode *get_subtree_internal_recurse (int tr, lnode **, int * );

lnode *get_subtree_external (int tr, lnode *, int );
lnode *get_subtree_external_recurse (int tr, lnode **, int * );
