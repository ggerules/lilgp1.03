...
#define OPERATOR_CROSSOVER      1             /* changed 0->1 by czj but seems unused */
#define OPERATOR_REPRODUCE      2
#define OPERATOR_MUTATE         3
#define OPERATOR_UNIFORM_MUTATE 4              /* czj added */
#define OPERATOR_REGROW         5              /* added by czj to regrow indiv */
