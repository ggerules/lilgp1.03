...
#write.table(d, file = "3_gsfbri2_orig_kern.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_orig_yadf.pdf")
...
#write.table(d, file = "3_gsfbri2_cgp2p1_nwadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_cgp2p1_nwadf.pdf")
...
#write.table(d, file = "3_gsfbri2_cgp2p1_ywadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_cgp2p1_ywadf.pdf")
...
#write.table(d, file = "3_gsfbri2_acgp1p1p2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_acgp1p1p2.pdf")
...
#write.table(d, file = "3_gsfbri2_acgp2p1_ywadf_what0.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_acgp2.1_what0.pdf")
...
#write.table(d, file = "3_gsfbri2_acgp2p1_ywadf_what1.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_acgp2.1_what1.pdf")
...
#write.table(d, file = "3_gsfbri2_acgp2p1_ywadf_what2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_acgp2.1_what2.pdf")
...
#write.table(d, file = "3_gsfbri2_acgp2p1_ywadf_what3.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gsfbri2_acgp2.1_what3.pdf")
