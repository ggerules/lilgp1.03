...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_orig_kern.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="11_md5_3_3_3_gsfbri1_orig_yadf.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_cgp2p1_nwadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
plot <- ggplot(df, aes(x=x, y=val, group=framework, color=framework, linetype = framework)) + geom_line() +
  labs(title="Lawnmower 8x8, Maxdepth == 5 - Mean of Standard Fitness of Best of Run Individuals\n by Generation Number", subtitle="Original  kernel.cgp2.1 Used\n 30 Independent Runs\n (wADF = n, ADF = n)", x="Generation Number", y="Mean Standard Fitness Best of Run Individuals")  + ylim(0,1)
ggsave(plot, file="11_md5_3_3_3_gsfbri1_cgp2p1_nwadf.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_cgp2p1_ywadf_nadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
plot <- ggplot(df, aes(x=x, y=val, group=framework, color=framework, linetype = framework)) + geom_line() +
  labs(title="Lawnmower 8x8, Maxdepth == 5 - Mean of Standard Fitness of Best of Run Individuals\n by Generation Number", subtitle="New kernel.cgp2.1_adf Used\n 30 Independent Runs\n (wADF = y, ADF = n)", x="Generation Number", y="Mean Standard Fitness Best of Run Individuals")  + ylim(0,1)
ggsave(plot, file="11_md5_3_3_3_gsfbri1_cgp2p1_ywadf_adfn.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_cgp2p1_ywadf_yadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
plot <- ggplot(df, aes(x=x, y=val, group=framework, color=framework, linetype = framework)) + geom_line() +
  labs(title="Lawnmower 8x8, Maxdepth == 5 - Mean of Standard Fitness of Best of Run Individuals\n by Generation Number", subtitle="New kernel.cgp2.1_adf Used\n 30 Independent Runs\n (wADF = y, ADF = y)", x="Generation Number", y="Mean Standard Fitness Best of Run Individuals")  + ylim(0,1)
ggsave(plot, file="11_md5_3_3_3_gsfbri1_cgp2p1_ywadf_adfy.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_acgp1p1p2_nwadf_ncons.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
plot <- ggplot(df, aes(x=x, y=val, group=framework, color=framework, linetype = framework)) + geom_line() +
  labs(title="Lawnmower 8x8, Maxdepth == 5 - Mean of Standard Fitness of Best of Run Individuals\n by Generation Number", subtitle="Original kernel.acgp1.1.2  Used\n 30 Independent Runs\n (wADF = n, ADF = n, Types = n, Constraints = n)", x="Generation Number", y="Mean Standard Fitness Best of Run Individuals")  + ylim(0,1)
ggsave(plot, file="11_md5_3_3_3_gsfbri1_acgp1.1.2_ncons.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_acgp1p1p2_nwadf_ycons.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
plot <- ggplot(df, aes(x=x, y=val, group=framework, color=framework, linetype = framework)) + geom_line() +
  labs(title="Lawnmower 8x8, Maxdepth == 5 - Mean of Standard Fitness of Best of Run Individuals\n by Generation Number", subtitle="Original kernel.acgp1.1.2 Used\n 30 Independent Runs\n  (wADF = n, ADF = n, Types = n, Constraints = y)", x="Generation Number", y="Mean Standard Fitness Best of Run Individuals")  + ylim(0,1)
#ggsave(plot, file="11_md5_3_3_3_gsfbri1_acgp1.1.2_ycons.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_acgp2p1_ywadf_what0.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="11_md5_3_3_3_gsfbri1_acgp2.1_what0.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_acgp2p1_ywadf_what1.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="11_md5_3_3_3_gsfbri1_acgp2.1_what1.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_acgp2p1_ywadf_what2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="11_md5_3_3_3_gsfbri1_acgp2.1_what2.pdf")
...
#write.table(d, file = "11_md5_3_3_3_gsfbri1_acgp2p1_ywadf_what3.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="11_md5_3_3_3_gsfbri1_acgp2.1_what3.pdf")
