...
#write.table(d, file = "3_gtsbri1_orig_kern.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_orig_yadf.pdf")
...
#write.table(d, file = "3_gtsbri1_cgp2p1_nwadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_cgp2p1_nwadf.pdf")
...
d <- dats %>% 
      ...
      #summarise(num = n()) %>%
      summarise(mean = mean(TreeSizeBestOfRunInd)) %>%
      filter(ProblemNum == 3, Kernel == 2, wADF == "n")

#write.table(d, file = "3_gtsbri1_cgp2p1_ywadf_nadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_cgp2p1_ywadf_adfn.pdf")
...
d <- dats %>% 
      ...
      #summarise(num = n()) %>%
      summarise(mean = mean(TreeSizeBestOfRunInd)) %>%
      filter(ProblemNum == 3, Kernel == 2, wADF == "y")

#write.table(d, file = "3_gtsbri1_cgp2p1_ywadf_yadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_cgp2p1_ywadf_adfy.pdf")
...
d <- dats %>% 
      ...
      #summarise(num = n()) %>%
      summarise(mean = mean(TreeSizeBestOfRunInd)) %>%
      filter(ProblemNum == 3, Kernel == 3, Constraints == "n")

#write.table(d, file = "3_gtsbri1_acgp1p1p2_nwadf_ncons.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_acgp1.1.2_ncons.pdf")
...
d <- dats %>% 
      ...
      #summarise(num = n()) %>%
      summarise(mean = mean(TreeSizeBestOfRunInd)) %>%
      filter(ProblemNum == 3, Kernel == 3, Constraints == "y")

#write.table(d, file = "3_gtsbri1_acgp1p1p2_nwadf_ycons.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gtsbri1_acgp1.1.2_ycons.pdf")
...
#write.table(d, file = "3_gtsbri1_acgp2p1_ywadf_what0.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_acgp2.1_what0.pdf")
...
#write.table(d, file = "3_gtsbri1_acgp2p1_ywadf_what1.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_acgp2.1_what1.pdf")
...
#write.table(d, file = "3_gtsbri1_acgp2p1_ywadf_what2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_acgp2.1_what2.pdf")
...
#write.table(d, file = "3_gtsbri1_acgp2p1_ywadf_what3.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
ggsave(plot, file="3_gtsbri1_acgp2.1_what3.pdf")
