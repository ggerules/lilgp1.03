...
##write.table(d, file = "3_gsfbgi3_orig_kern.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#write.table(d1, file = "3_gsfbgi3_cgp2p1_nadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
#write.table(d2, file = "3_gsfbgi3_cgp2p1_nadf.csv", append = TRUE, sep = ",", col.names = FALSE, row.names = FALSE, qmethod = "double")
...
str(x)
framework <- c(
 rep("cgp2.1_nwadf_ntypes_ncons",501), 
 rep("cgp2.1_ywadf_ntypes_ncons",501), 
 rep("cgp2.1_nwadf_ntypes_ycons",501), 
 rep("cgp2.1_ywadf_ntypes_ycons",501), 
 rep("cgp2.1_nwadf_ytypes_ncons",501), 
 rep("cgp2.1_ywadf_ytypes_ncons",501), 
 rep("cgp2.1_nwadf_ytypes_ycons",501),
 rep("cgp2.1_ywadf_ytypes_ycons",501)
)
str(framework)
...
plot <- ggplot(df, aes(x=x, y=val, group=framework, color=framework, linetype = framework)) + geom_line() +
  labs(title="Two Box - Mean of Standard Fitness of Best of Gen Individuals\n by Generation Number", subtitle="Original  kernel.cgp2.1 Used\n 30 Independent Runs\n (ADF = n)", x="Generation Number", y="Mean Standard Fitness Best of Gen Individuals")  + ylim(0,1)
#ggsave(plot, file="3_gsfbgi3_cgp2p1_nadf.pdf")
...
##write.table(d, file = "3_gsfbgi3_cgp2p1_ywadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
str(x)
framework <- c(
 rep("cgp2.1_nadf_ntypes_ncons",501), 
 rep("cgp2.1_nadf_ntypes_ycons",501), 
 rep("cgp2.1_nadf_ytypes_ncons",501), 
 rep("cgp2.1_nadf_ytypes_ycons",501),
 rep("cgp2.1_yadf_ntypes_ncons",501), 
 rep("cgp2.1_yadf_ntypes_ycons",501), 
 rep("cgp2.1_yadf_ytypes_ncons",501), 
 rep("cgp2.1_yadf_ytypes_ycons",501)
)
str(framework)
val <- c(o1$mean, o2$mean, o3$mean, o4$mean, o5$mean, o6$mean, o7$mean, o8$mean)
str(val)
...
#ggsave(plot, file="3_gsfbgi3_cgp2p1_ywadf.pdf")
...
#write.table(d, file = "3_gsfbgi3_acgp1p1p2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
str(x)
framework <- c(
 rep("acgp1.1.2_ncons_what0",501), 
 rep("acgp1.1.2_ncons_what1",501), 
 rep("acgp1.1.2_ncons_what2",501), 
 rep("acgp1.1.2_ncons_what3",501), 
 rep("acgp1.1.2_ycons_what0",501), 
 rep("acgp1.1.2_ycons_what1",501), 
 rep("acgp1.1.2_ycons_what2",501), 
 rep("acgp1.1.2_ycons_what3",501) 
)
str(framework)
val <- c(o1$mean, o2$mean, o3$mean, o4$mean, o5$mean, o6$mean, o7$mean, o8$mean)
str(val)
...
plot <- ggplot(df, aes(x=x, y=val, group=framework, color=framework, linetype = framework)) + geom_line() +
  labs(title="Two Box - Mean of Standard Fitness of Best of Gen Individuals\n by Generation Number", subtitle="Original kernel.acgp1.1.2  Used\n 30 Independent Runs\n (wADF = n, ADF = n, Types = n)", x="Generation Number", y="Mean Standard Fitness Best of Gen Individuals")  + ylim(0,1)
#ggsave(plot, file="3_gsfbgi3_acgp1p1p2.pdf")
...
##write.table(d, file = "3_gsfbgi3_acgp2p1_ywadf_what0.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
str(x)
framework <- c(
 rep("acgp2.1_nafd_ntypes_ncons",501), 
 rep("acgp2.1_nafd_ntypes_ycons",501), 
 rep("acgp2.1_nafd_ytypes_ncons",501), 
 rep("acgp2.1_nafd_ytypes_ycons",501), 
 rep("acgp2.1_yafd_ntypes_ncons",501), 
 rep("acgp2.1_yafd_ntypes_ycons",501), 
 rep("acgp2.1_yafd_ytypes_ncons",501), 
 rep("acgp2.1_yafd_ytypes_ycons",501) 
)
str(framework)
val <- c(o1$mean, o2$mean, o3$mean, o4$mean, o5$mean, o6$mean, o7$mean, o8$mean)
str(val)
...
#ggsave(plot, file="3_gsfbgi3_acgp2.1_what0.pdf")
...
##write.table(d, file = "3_gsfbgi3_acgp2p1_ywadf_what1.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbgi3_acgp2.1_what1.pdf")
...
##write.table(d, file = "3_gsfbgi3_acgp2p1_ywadf_what2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbgi3_acgp2.1_what2.pdf")
...
##write.table(d, file = "3_gsfbgi3_acgp2p1_ywadf_what3.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbgi3_acgp2.1_what3.pdf")
