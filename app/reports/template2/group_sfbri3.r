...
##write.table(d, file = "3_gsfbri3_orig_kern.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_orig_yadf.pdf")
...
#write.table(d1, file = "3_gsfbri3_cgp2p1_nadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
#write.table(d2, file = "3_gsfbri3_cgp2p1_nadf.csv", append = TRUE, sep = ",", col.names = FALSE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_cgp2p1_nadf.pdf")
...
##write.table(d, file = "3_gsfbri3_cgp2p1_ywadf.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_cgp2p1_ywadf.pdf")
...
#write.table(d, file = "3_gsfbri3_acgp1p1p2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_acgp1p1p2.pdf")
...
##write.table(d, file = "3_gsfbri3_acgp2p1_ywadf_what0.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_acgp2.1_what0.pdf")
...
##write.table(d, file = "3_gsfbri3_acgp2p1_ywadf_what1.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_acgp2.1_what1.pdf")
...
##write.table(d, file = "3_gsfbri3_acgp2p1_ywadf_what2.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_acgp2.1_what2.pdf")
...
##write.table(d, file = "3_gsfbri3_acgp2p1_ywadf_what3.csv", sep = ",", col.names = TRUE, row.names = FALSE, qmethod = "double")
...
#ggsave(plot, file="3_gsfbri3_acgp2.1_what3.pdf")
