...
DATATYPE f_mul( int tree, farg *args )
{
 ...
 */
DATATYPE f_div( int tree, farg *args )
{
...
DATATYPE f_x( int tree, farg *args )
{
     return g.x;
}

DATATYPE f_a( int tree, farg *args )
{
     return g.a;
}

DATATYPE f_p( int tree, farg *args )
{
     return g.p;
}

DATATYPE f_s( int tree, farg *args )
{
     return g.p;
}
