...
hits <- read.table("/home/ggerules/lilgp1.02/app/prob007_koza1_cuda/data/sttlong.csv", header=TRUE, sep=",", na.strings="NA", dec=".", strip.white=TRUE)
